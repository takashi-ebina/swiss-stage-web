 ...
 * グループ参加者リストの集約ルート
 * 
 * グループに所属する参加者のライフサイクルを管理する。 主な責務: - 参加者の追加・削除（32名上限チェック） - ダミーユーザーの自動管理（奇数→ダミー追加、偶数→削除） -
 * 参加者リストの段級位順・登録順ソート - CSV入出力のデータ整合性保証
 */
public class GroupParticipantList {
    ...
    /**
     * 参加者を追加する 32名上限チェックとダミーユーザー管理を実行する
     * 
    ...
    /**
     * 参加者数が偶数になるようダミーユーザーを調整する - 奇数の場合: ダミーユーザーを追加 - 偶数の場合: ダミーユーザーを削除
     */
    ...
    /**
     * 段級位順→登録順でソートされた参加者リストを取得する ダミーユーザーは末尾に配置される
     * 
     * @return ソート済み参加者リスト
     */
    ...
    /**
     * CSV出力用の参加者リストを取得する ダミーユーザーを除外し、登録順でソートする
     * 
     * @return CSV出力用参加者リスト
     */
