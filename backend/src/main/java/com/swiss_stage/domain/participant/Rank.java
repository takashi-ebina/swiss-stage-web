 ...
 * 段級位を表す値オブジェクト
 * 
 * 有効な段級位: - 段位: 初段、2段、3段、...、9段 - 級位: 1級、2級、3級、...、20級
 * 
 * level値の変換ルール: - 段位: 正の整数（初段=1、2段=2、...、9段=9） - 級位: 負の整数（1級=-1、2級=-2、...、20級=-20）
 * 
...
public record Rank(int level, String displayName) implements Comparable<Rank> {
    ...
    /**
     * 段級位の正規表現パターン - 初段: 初段（1段は初段のみ有効） - 2-9段: 2段、3段、...、9段 - 1-20級: 1級、2級、...、19級、20級
     */
